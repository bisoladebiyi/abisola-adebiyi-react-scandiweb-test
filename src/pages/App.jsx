...
class App extends Component {
  ...
  render() {
    ...
    const currencies = data.categories && data.categories[0].products[0].prices.map((price) => ({symbol: price.currency.symbol, label: price.currency.label }))

    return (
      <BrowserRouter>
        <Layout categories={categories} currencies={currencies} active={this.state.activeCategory}>
          <div className="App">
            <Routes>
